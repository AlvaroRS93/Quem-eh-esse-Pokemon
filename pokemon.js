...
function sorteiaEExibe() {
    ...
    while (auxiliar < 1){
        ...
        for(j = 0; j < 3; j++){
            listaIdPokemons[1] = listaIdPokemons[0]+1;
            listaIdPokemons[2] = listaIdPokemons[0]+2;
            listaIdPokemons[3] = listaIdPokemons[0]-1;
        }
...
async function retornaPokemon(lista) {
    var objPokemon;
    var listaDadosPokemons = [];
        ...
        fetch("https://pokeapi.co/api/v2/pokemon/" + lista[i])
            ...
            .then(function (pokemon) {
                ...
                if (listaDadosPokemons.length == 4){
                    ...
                    fotoMostrada.style.display = "inline-block";
...
function exibeTabelaDePontuacao() {
